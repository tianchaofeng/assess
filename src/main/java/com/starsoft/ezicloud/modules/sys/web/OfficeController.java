...
import com.starsoft.ezicloud.modules.sys.service.OfficeService;
...
//        model.addAttribute("list", officeService.findAll());
	...
	public String reference(Office office, Model model,HttpServletRequest request,HttpServletResponse response) {
		Page<Office> page = new Page<Office>(request,response);
		office.setPage(page);
		List<Office> list=officeService.getByType(office);
		page.setList(list);
		model.addAttribute("page", page);
		model.addAttribute("type", office.getType());
		return "modules/sys/officeReferenceList";
	}
