...
import com.starsoft.ezicloud.common.beanvalidator.BeanValidators;
...
import com.starsoft.ezicloud.common.utils.excel.ImportExcel;
...
import com.starsoft.ezicloud.modules.sys.service.SystemService;
...
public class UserController extends BaseController {
	...
	public String reference(User user,String type,HttpServletRequest request,HttpServletResponse response, Model model) {
		if (StringUtils.isBlank(type)) {
			...
			user.setNo(name);
//			user2.se
			List<User> list=userDao.getTeamUser(user);
			page.setList(list);
			model.addAttribute("page", page);
		}else {
			...
			user.setPage(page);
			user.setUserType(type);
			List<User> list=userDao.getByType(user);
			page.setList(list);
			model.addAttribute("page", page);
		}
		model.addAttribute("type",type);
		return "modules/sys/userReferenceList";
	}
