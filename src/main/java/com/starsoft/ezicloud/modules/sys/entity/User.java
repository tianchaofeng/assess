 ...
 */
package com.starsoft.ezicloud.modules.sys.entity;
...
import com.starsoft.ezicloud.common.supcan.annotation.treelist.cols.SupCol;
...
public class User extends DataEntity<User> {
	...
	private DbCourseinfo course;//科目
	...
	public DbCourseinfo getCourse() {
		return course;
	}

	public void setCourse(DbCourseinfo course) {
		this.course = course;
	}
	...
	@Length(min=0, max=100, message="职称长度必须介于 1 和 100 之间")
	@ExcelField(title="职称", align=2, sort=85, dictType="job_title")
