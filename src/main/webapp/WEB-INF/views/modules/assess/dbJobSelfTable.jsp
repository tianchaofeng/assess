...
<head>
    ...
    function aa() {
		window.location.href="${ctx}/assess/dbJob/aa"
    }
</script>
</head>
<body><%-- <c:forEach items="${dbLevelList1}" var="dbLevel1" varStatus="varStatus1">--%>
<ul id="yin" class="nav nav-tabs noprint">
	...
	<ul id="yin1" class="nav nav-tabs noprint">
		...
		<li>
			...
			<%--<input id="" class="btn btn-primary" type="button" value="kk" onclick="aa()"/>--%>
		</li>
	</ul>
