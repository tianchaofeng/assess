	...
	<div id="main">
	    ...
	    <div class="container">
		    ...
		    <div id="footer" class="row">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')}<!--  - Powered By <a href="http://www.stars-soft.com" target="_blank">EziCloud</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
