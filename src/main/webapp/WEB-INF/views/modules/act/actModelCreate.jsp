...
<body>
	...
	<form id="inputForm" action="${ctx}/act/model/create" target="_blank" method="post" class="form-horizontal">
		<div class="control-group">
			...
			<div class="controls">
				<select id="category" name="category" class="required input-medium input-xlarge">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="name" name="name" type="text" class="required input-xlarge" />
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="key" name="key" type="text" class="required input-xlarge" />
				<span class="help-inline"></span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls"> 
				<textarea id="description" name="description" class="required input-xlarge"></textarea>
			</div>
		</div>
